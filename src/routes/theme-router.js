...
const { themeValidator, themeUpdatedValidator } = require('../validators/theme-validator');
...
themeRouter
	...
	.put(authJWT(), bodyValidation(themeUpdatedValidator), themeController.update) //! route update
